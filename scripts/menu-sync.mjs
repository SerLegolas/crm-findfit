...
const MENU_CONFIG = join(ROOT, ".github", "menu-config.md");
const REGISTER = join(ROOT, "app", "api", "auth", "register", "route.ts");
const SUPERUSER_PAGE = join(ROOT, "app", "superuser", "admin", "[id]", "page.tsx");
